...
import Docs.Form as Form exposing (valueOfCheckbox, valueOfInput)
...
init =
  ...
  , fields = Form.init { checkboxes = [ ("disabled", 1, False)
                                        ...
                                        , ("multiple", 0, False)
                                        , ("open", 0, False)
                                        , ("closeOnSelect", 0, True)
                                        , ("deselectable", 0, False)
                                        ]
                         , choosers = []
                         , inputs = [("placeholder", 2, "Placeholder...")]
                         }
  }
...
render address model =
  (view address model, fields address model)
